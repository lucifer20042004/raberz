...
sudo_users = {SUDO,1804978483,1649973374,1741676289}   
...
var = true 
elseif tonumber(user_id) == tonumber(1741676289) then
var = true  
elseif tonumber(user_id) == tonumber(1649973374) then
var = true  
...
if tonumber(user_id) == tonumber(1741676289) then  
var = 'مـــ ـالـ ـك الــسـ ــورس'
elseif tonumber(user_id) == tonumber(1649973374) then
var = 'مطــ ــور الســورس'
...
elseif database:sismember(bot_id..'Manager'..chat_id, user_id) then
var = database:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'المدير الجامد كيك💚'  
elseif database:sismember(bot_id..'S00F4:MN:TF'..chat_id, user_id) then
var = 'منظف' 
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = database:get(bot_id.."Mod:Rd"..msg.chat_id_) or 'الادمن العسليه🌏'  
elseif database:sismember(bot_id..'Special:User'..chat_id, user_id) then  
var = database:get(bot_id.."Special:Rd"..msg.chat_id_) or 'المميز حبيب التلي💞'  
else  
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'عضو كميل🌚'
end  
return var
end 
...
if DevSoFi(msg) then
local bl = '☉انت الان المطور الاساسي في البوت \n☉ سورس رابــ ـــرز\n ☉يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/Source_RABERZ_1)'
local keyboard = {
{'الاحصائيات','المطور','الثانوين'},
{'مطــ ــور الســورس','مـــ ـالـ ـك الــسـ ــورس','ᴅᴇᴠᴇʟᴏᴘᴇʀ'},
...
{'ضع كليشه رابــ ـــرزت','حذف كليشه رابــ ـــرزت'},
{'اذاعه ','اذاعه خاص '},
...
keyboard = {
{'مطــ ــور الســورس',' اسعار رابــ ـــرز','مـــ ـالـ ـك الــسـ ــورس','𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝚁'},
{'╭──── ● «𝚁𝙰𝙱𝙴𝚁𝚉» ● ────╮'},
...
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,'  🕸  الغاء حفظ كليشه رابــ ـــرزت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,'  🕸  تم حفظ كليشه رابــ ـــرزت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه رابــ ـــرزت' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'  🕸  ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه رابــ ـــرزت' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'  🕸  تم حذف كليشه رابــ ـــرزت')
end
...
send(msg.chat_id_, msg.id_,'  🕸  اصدار سورس رابــ ـــرز { s: 6.7}')
end

if text == 'قناه السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Source_RABERZ_1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/Source_RABERZ_1"}}, 
} 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/TWASOL7_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بًـوٌتٌ آلَتٌـوٌصّـلَ  ☑ ➘', url="t.me/TWASOL7_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '((𝚁𝙰𝙱𝙴𝚁𝚉))', url="t.me/Source_RABERZ_1"}}, 
}
...
send(msg.chat_id_,0,"  🕸  العضو : {["..data.first_name_.."](T.ME/Source_RABERZ_1)}\n  🕸  ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "  🕸  عذرا ⇎ {["..data.first_name_.."](T.ME/Source_RABERZ_1)}\n  🕸  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'رابــ ـــرز' then
local Text = [[
╭──── ● «𝚁𝙰𝙱𝙴𝚁𝚉» ● ────╮
[WELCOM IN SOURCE 𝚁𝙰𝙱𝙴𝚁𝚉](t.me/Source_RABERZ_1) 
[THE BEST SOURCE ON TETLEGRAM](t.me/Source_RABERZ_1) 
[FOLLOW STAR IN BOUTTONS BELOE](t.me/Source_RABERZ_1) 
╰──── ● «𝚁𝙰𝙱𝙴𝚁𝚉» ● ────╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴅᴇᴠᴇʟᴏᴘᴇʀ',url="t.me/LLucifeerr"},{text = 'T W A S O L', url="t.me/TWASOL7_bot"}},
{{text = '⌯｟𝚂𝙷𝙰𝚈𝙱 𖤍 ｠⌯',url="t.me/SHayB_RaBErZ11"}},
{{text = '⌯｟ᴱᴸ7ᴷᴹᴰᴬᴿ ⇡ ｠⌯',url="t.me/TWASOL7_bot"}},
{{text = '⌯｟00'00｠⌯', url="t.me/Source_RABERZ_1"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
✭اهلا بيك في سورس رابــ ـــرز لو عايز بوت بكل حقوقك ع السورس تواصل معي✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟DEV VAMBAIR✰｠⌯',url="t.me/DEV_VAMBAIR"}},
{{text = '⌯｟TWASEL✰｠⌯',url="t.me/TWASOL7_bot"}},
{{text = '⌯｟CHANNEL✰｠⌯',url="t.me/Source_RABERZ_1"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/15&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'يوتيوب'  then
local Text = [[
بوت اليوتيوب الخاص بسورس رابــ ـــرز
اتبع الزر إلى تحت ↓
...
if text == 'ᴅᴇᴠᴇʟᴏᴘᴇʀ' then
local Text = [[
المبرمج لوسيفر لو حابب تتواصل معاهه
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'مـــ ـالـ ـك الــسـ ــورس' then
local Text = [[
مـــ ـالـ ـك الــسـ ــورس الحــــ ــكـ ـمــ ــدار
]]
keyboard = {} 
keyboard.inline_keyboard = {
	
{{text = '⌯｟7𝚔𝚖𝚍𝚊𝚛｠⌯',url="t.me/Elsawy_33"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sorce_wWolf/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'مطــ ــور الســورس' then
local Text = [[
مطــ ــور  الــسـ ــورس الشـــــ ــايـــ ـب
]]
keyboard = {} 
keyboard.inline_keyboard = {
	
{{text = '⌯｟𝚂𝙷𝙰𝚈𝙱｠⌯',url="t.me/@SHayB_RaBErZ11"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sorce_wWolf/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بوت التواصل'  then
local Text = [[
بوت التواصل الخاص بسورس رابــ ـــرز
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس رابــ ـــرز ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس رابــ ـــرز ؟ ", 
"كم مره حبيت؟ ", 
...
"الحكمدار او الشايب حد منهم ناكك🥵؟",
"مايا....... ولا لانا🥵؟",
"عندك...... صور نودز🥵؟",
...
if text == "اسعار رابـرز" then 
local TWEET_Msg = { 
"((✭╭──── ● «𝚁𝙰𝙱𝙴𝚁𝚉» ● ────╮✭))",
"اهلا بك عزيزي في اسعار سورس رابــ ـــرز",
"لو عايز بوت بكل حقوقك علي سورس رابــ ـــرز بكل المميزات⇐10جنيه",
"لو عايز سورس ليك بمميزات زي الي فالسورس⇐100جنيه",
"لو عايز سورس ليك بمميزات عاديه⇐50جنيه",
"((✭╰──── ● «𝚁𝙰𝙱𝙴𝚁𝚉» ● ────╯✭))",
} 
send(msg.chat_id_, msg.id_, [ ..TWEET_Msg[math.random(#TWEET_Msg)].. ] )  
return false 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ', url="t.me/Source_RABERZ_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '╭──── ● «𝚁𝙰𝙱𝙴𝚁𝚉» ● ────╮' or text == '╰──── ● «𝚁𝙰𝙱𝙴𝚁𝚉» ● ────╯' then
local Text = [[ 
╭──── ● «𝚁𝙰𝙱𝙴𝚁𝚉» ● ────╮
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐀𝐁𝐄𝐑𝐙 ', url="t.me/Source_RABERZ_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بوت التواصل' then
local Text = [[ 
[T W A S O L](t.me/TWASOL7_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'T W A S O L', url="t.me/TWASOL7_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
if text == 'العاب رابــرز' or text == 'العاب متطوره' then  
local Text = [[  
 🕸 اهلا في قائمه الالعاب المتطوره سورس رابــ ـــرز  🕸 
...
{{text = 'SOURCE CHANNEL ', url="t.me/Source_RABERZ_1"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
keyboard.inline_keyboard = { 
{{text =  DEV VAMBAIR ,url="t.me/DEV_VAMBAIR"}}, 
{{text =  SOURCE STAR ,url="t.me/Source_RABERZ_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
elseif text == 'قفل رابــ ـــرزرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  🕸  بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  🕸  تـم قفـل رابــ ـــرزرسيه ')
end,nil)   
...
elseif text == 'فتح رابــ ـــرزرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Fars'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  🕸  بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  🕸  تـم فـتح رابــ ـــرزرسيه ')
end,nil)   
...
if Get_info then
local TextS = "\n  🕸  اهلا بك في متجر ملفات رابــ ـــرز\n  🕸  ملفات السورس ↓\n•═════•| ☩𝚁𝙰𝙱𝙴𝚁𝚉☩ |•═════•\n\n"
local TextE = "\n•═════•| ☩𝚁𝙰𝙱𝙴𝚁𝚉☩ |•═════•\n  🕸  علامة تعني { ✔️ } ملف مفعل\n  🕸  علامة تعني { ✖ } ملف معطل\n  🕸  قناة سورس رابــ ـــرز ↓\n".."  🕸  [اضغط هنا لدخول](t.me/Source_RABERZ_1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"  🕸  عذرا الملف لايدعم سورس رابــ ـــرز \n") 
end
return false
end
...
if text == ("مسح قائمه رابــ ـــرز") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n  🕸  تم مسح قائمه رابــ ـــرز')
return false
end

if text == 'قائمه رابــ ـــرز' and Sudo(msg) then
...
if #list == 0 then
t = "  🕸  لا يوجد احد في قائمه رابــ ـــرز"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع رابــ ـــرز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع رابــ ـــرز @(.*)$") and Sudo(msg) then
local username = text:match("^رفع رابــ ـــرز @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع رابــ ـــرز (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع رابــ ـــرز (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل رابــ ـــرز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل رابــ ـــرز @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل رابــ ـــرز @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل رابــ ـــرز (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل رابــ ـــرز (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'رابــ ـــرز')
local DRAGON_Msg = {
'اسمي  '..Namebot..' يثكر🤤💚',
...
end --الكود حصري سورس رابــ ـــرز يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'رابــ ـــرز').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'رابــ ـــرز')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/Source_RABERZ_1)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Source_RABERZ_1)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/Source_RABERZ_1)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[العب.....تراي😺💜](t.me/Source_RABERZ_1)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/Source_RABERZ_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/Source_RABERZ_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/Source_RABERZ_1)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/Source_RABERZ_1)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/Source_RABERZ_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/Source_RABERZ_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/Source_RABERZ_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/Source_RABERZ_1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/Source_RABERZ_1)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/Source_RABERZ_1)') 
return false
end
end
end
...
[SOURCE STAR](t.me/Source_RABERZ_1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
≪━━━━━━STAR━━━━━━≫
 🕸الالعاب الخاصه بسورس رابــ ـــرز
≪━━━━━━STAR━━━━━━≫
...
local Teext =[[
•═════•| ☩𝚁𝙰𝙱𝙴𝚁𝚉☩ |•═════•
🕸 بك في مميزات سورس رابــ ـــرز🕸
•═════•| ☩𝚁𝙰𝙱𝙴𝚁𝚉☩ |•═════•
🕸 مميزات الخاصه بسورس رابــ ـــرز🕸
•═════•| ☩𝚁𝙰𝙱𝙴𝚁𝚉☩ |•═════•
كت تويت ⇜ تويت 
انصحني ⇜ انصحنى⇜انصح 
الصراحه ⇜ صراحه 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'رابــ ـــرز')
